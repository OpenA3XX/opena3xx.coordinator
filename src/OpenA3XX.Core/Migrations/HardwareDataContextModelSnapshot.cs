...
namespace OpenA3XX.Coordinator.TestHarness.Migrations
{
    ...
    internal class HardwareDataContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenA3XX.Core.Models.AircraftModel", b => { b.Navigation("HardwarePanels"); });

            modelBuilder.Entity("OpenA3XX.Core.Models.HardwareBoard", b => { b.Navigation("Buses"); });

            modelBuilder.Entity("OpenA3XX.Core.Models.HardwareInput",
                b => { b.Navigation("HardwareInputSelectorList"); });

            modelBuilder.Entity("OpenA3XX.Core.Models.HardwareOutput",
                b => { b.Navigation("HardwareOutputSelectorList"); });
            ...
            modelBuilder.Entity("OpenA3XX.Core.Models.IOExtenderBus", b => { b.Navigation("Bits"); });

            modelBuilder.Entity("OpenA3XX.Core.Models.Manufacturer", b => { b.Navigation("AircraftModels"); });
